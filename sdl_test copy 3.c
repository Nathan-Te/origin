...
int main(int argc, char *argv[])
{
    ...
    const int limite_compteur_animation = 35;
...
*/
    ...
    SDL_SetRenderDrawColor(pRenderer, 255, 255, 255, 255);
      ...
      */
      ...
      /*
      if (key_right_pressed == key_down_pressed == key_left_pressed == key_up_pressed == false){
        idle = true;
      }
      else {
        idle = false;
      ...
      */
      int lol = 100;
        ...
        if (key_right_pressed == false && key_down_pressed == false && key_left_pressed == false && key_up_pressed == false && look == 0){
